...
testDockerBuild () {
  testName=docker-build-context
  testDir=$testsDir/docker-build-context
  printf "testing %s... " "$testName"
  
  ##########################################################
  # Test1: Test docker-build-context by running the build pipeline #
  ##########################################################
  ...
  imagename=docker-build-image-name-2
